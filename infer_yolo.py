...
model = YOLO("runs_yolo/train_0707/weights/best.pt")
img = cv2.imread(r"D:\_DATA\taihe_0625\hangdian\yolo\val\images\DJI_20250624185601_0004_1_0_16.jpg")

results = model.predict(model="runs_yolo/corn_yolo.yaml", source=img, save=False, imgsz=512, conf=0.1, iou=0.2, verbose=False)
...
combined = np.vstack((img, yolo_img, mask_img))
