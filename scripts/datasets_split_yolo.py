...
def split_data(file_path, label_path, new_file_path, train_rate, val_rate, test_rate):
    ...
    images_no_ext = {os.path.splitext(image)[0]: image for image in images if image.endswith(".jpg")}
...
if __name__ == '__main__':
    file_path = r"D:\_DATA\taihe_0625\hangdian\yolo\data"  # 图片文件夹
    label_path = r'D:\_DATA\taihe_0625\hangdian\yolo\label'  # 标签文件夹
    new_file_path = r"D:\_DATA\taihe_0625\hangdian\yolo"  # 新数据存放位置
